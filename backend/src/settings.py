...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'helpers.handle_errors.custom_exception_handler',
    ...
    'DEFAULT_THROTTLE_RATES': {
        'user': '6/hour' if not DEBUG else '1000/minute',
        'anon': '10/minute' if not DEBUG else '1000/minute',
        'simple': '10/minute' if not DEBUG else '1000/minute',
    },
